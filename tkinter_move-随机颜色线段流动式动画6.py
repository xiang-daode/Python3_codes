...
for t in range(0, 3600, 1):  # 总循环多少次
    for k in range(t, t + 37):  # 每次生成多少个
        xt = 600 * (1 + 0.75 * math.cos(k / 36)+ 0.15 * math.cos(k / 4))
        yt = 400 * (1 + 0.75 * math.sin(k / 36)+ 0.15 * math.sin(k / 4))
        k2 = k - 1
        xt2 = 600 * (1 + 0.75 * math.cos(k2 / 36)+ 0.15 * math.cos(k2 / 4))
        yt2 = 400 * (1 + 0.75 * math.sin(k2 / 36)+ 0.15 * math.sin(k2 / 4))
