...
for t in range(0, 3600, 1):  # 总循环多少次
    ...
    for k in range(t, t + 60):  # 每次生成多少个
        xt = 600 * (1 + 0.75 * math.cos(k / 5.9))
        yt = 400 * (1 + 0.75 * math.sin(k / 5.7))
        k2 = k + 0.37
        xt2 = 600 * (1 + 0.75 * math.cos(k2 / 4.8))
        yt2 = 400 * (1 + 0.75 * math.sin(k2 / 4.6))
    ...
    for k in range(t, t + 7):  # 每次生成多少个
        xt = 600 * (1 + 0.75 * math.cos(k / 6.9))
        yt = 400 * (1 + 0.75 * math.sin(k / 6.7))
        k2 = k - 0.17
        xt2 = 600 * (1 + 0.75 * math.cos(k2 / 7.8))
        yt2 = 400 * (1 + 0.75 * math.sin(k2 / 7.6))
