...
a,b,c=-300,300,1 #画球旋转角范围:起点,终点,步长
e,f,g=153,39,129 #画球形状控制参数
t=0
while True:  # 总循环多少次
    rgb = "#ffff88" # + str(hex(rnd.randint(0x100000, 0xFF00FF)))[2:]  # 生成随机颜色

    for k in range(a,b,c):  # 每次生成多少个
        #生成球面点集:
        xt = 0.815 * math.cos(k / e)* math.cos(k / f)
        yt = 0.815 * math.sin(k / e)* math.cos(k / f)
        zt = 0.815 * math.sin(k / f)
        #绕Y轴旋转:
