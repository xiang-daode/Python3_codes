...
a,b,c=-600,600,3 #画球旋转角范围:起点,终点,步长
e,f,g=13,79,109 #e,f:画球形状控制参数,g:旋转速度
t=0
xl,yl=0,0
while True:  # 总循环多少次
    ...
    for k in range(a,b,c):  # 每次生成多少个
        ...
        y3=400 * (1 + y2)
        #绘制线段集:
        rgb ='#'+ str(hex(int(0x100000+(x3*y3*k) % 0xefffff)))[2:]  # 生成颜色
        canvas.create_line(
            x3, y3, xl, yl, tag="pic" + str(k), fill=rgb,width=8
        )
        xl,yl=x3,y3
