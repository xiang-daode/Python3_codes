...
def coosys():    
    ...
    pencolor('green');line(0, 0, 300, 150);write("Y",  font = ("Times", 12,"bold"))
    pencolor('blue');line(0, -800, 0, 800);write("Z",  font = ("Times", 18,"bold"))
...
def main():
    ...
    color(1,0,0);goto(200,800);write("三段式机械臂之逆解",  font = ("黑体", 24,"bold"))
    ontimer(main,1000)
