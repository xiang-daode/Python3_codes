# 在这里写上你的代码 :-)
import math;import time;from tkinter import *

# 使用tkinter绘图:
root =Tk()
canvas =Canvas(width=1200, height=800, bg='#eeff99')
canvas.pack()
PI=3.14159265
# 每次的移动:
for t in range(0,9000,5):
        ...
        x0=t%1200
        y0=400
        canvas.create_line(x0, y0-10, x0, y0-40, fill='#001100', tag="pic_b2",width=25) #头
        canvas.create_line(x0, y0, x0, y0-10, fill='#001100', tag="pic_b2",width=10) #颈
        canvas.create_line(x0, y0, x0, y0+120, fill='#001100', tag="pic_b2",width=28)#上体
        #手L:
        ...
        x2=x1+80*(math.cos(g2))
        y2=y1+80*(math.sin(g2))
        canvas.create_line(x0, y0, x1, y1, fill='#110066', tag="pic_a3",width=19)
        canvas.create_line(x1, y1, x2, y2, fill='#110066', tag="pic_b3",width=19)
        ...
        x2=x1+80*(math.cos(g2))
        y2=y1+80*(math.sin(g2))
        canvas.create_line(x0, y0, x1, y1, fill='#116600', tag="pic_a4",width=19)
        canvas.create_line(x1, y1, x2, y2, fill='#116600', tag="pic_b4",width=19)
